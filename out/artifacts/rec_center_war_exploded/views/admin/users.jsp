...
<%--        <tr class="filters">--%>
<%--            <th><input type="text" class="form-control" placeholder="User id" disabled></th>--%>
<%--            &lt;%&ndash;                        <th><input type="text" class="form-control" placeholder="User id" disabled></th>&ndash;%&gt;--%>
<%--            <th><input type="text" class="form-control" placeholder="Full Name" disabled></th>--%>
<%--            <th><input type="text" class="form-control" placeholder="Phone" disabled></th>--%>
<%--            <th><input type="text" class="form-control" placeholder="Email" disabled></th>--%>
<%--&lt;%&ndash;            <th><input type="text" class="form-control" placeholder="Check In Time" disabled></th>&ndash;%&gt;--%>
...
<%--                <td><c:out value="${user.contact}" /></td>--%>
<%--                <td><c:out value="${user.email}" /></td>--%>
<%--&lt;%&ndash;                <td><c:out value="${user.checkInTime}" /></td>&ndash;%&gt;--%>
<%--            </tr>--%>
<%--        </c:forEach>--%>
<%--        </tbody>--%>
<%--    </table>--%>
